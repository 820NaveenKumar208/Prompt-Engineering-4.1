...
# Description:
To demonstrate how diverse AI prompting techniques can be used to train and fine-tune MediGuide's conversational abilities for various real-world healthcare scenarios, ensuring both empathy and accuracy.
## Background:
...
### Simple Summary:
Zero-shot worked best for basic guidance.
Few-shot improved consistency across similar queries.
Chain-of-thought added depth to decision-making.
Role-based enabled empathetic and personalized interaction.
Multi-modal expanded MediGuide’s capabilities beyond text-only inputs.


![Screenshot 2025-05-07 111010](https://github.com/user-attachments/assets/25ec87b2-d57a-4163-8862-70981857a7c4)
![Screenshot 2025-05-07 111022](https://github.com/user-attachments/assets/ba41d60e-835b-407d-9171-c391598e2198)
